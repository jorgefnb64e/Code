<template>
    <v-layout id="id_7" row wrap justify-center>
        ...
        <!-- v-flex es un contenedor flexible que posee una id para a sección de estilos y el valor "xs12" para 
        que adopte todo el tamaño de la pantalla -->
        <v-flex id="id_1" xs12>
            <!-- va un v-layout, otro contenedor con justify-center para centrar el contenido y luego se pone
            el titulo con un h1 -->
            <v-layout  justify-center>
                <h1>AÑADIR ESTUDIANTE</h1>
            </v-layout>
        </v-flex>
            <!-- aqui ponemos otro otros contenedores v-flex y v-lauout para el primer campo de texto -->
        <v-flex id="id_6" xs12>
            <v-layout  justify-center>
                <!-- v-text-field para añadir el campo de entrada de texto, v-model como enlace con la variable :counter
                para contador de texto, label para el nombre principal de la entrada de texto -->
            ...
            <!-- luego hacemos lo mismo para los demas campos -->
        <!-- se añaden contenedores para el boton que ejecutará la funcion, style="width: 30%" para asignarle un tamaño al
        boton, depressed deja al boton sin sombra, @click para asiganrle la funcion a ejecutar -->
         <v-flex id="id_2" xs12>
            <v-layout justify-center>
...
// en el script en la parte data return colocamos las variables del componente que atañen a los datos requeridos
// para los esudiantes
<script>
    ...
    export default {
        ...
        methods: {
            ...
            // luego en methods creamos la funcion y hacemos el enlace con el backend usando axios por medio de la
            //ruta
            crearEstudiante(){
                axios.post('http://localhost:3000/estudiantes',
                {
                    // despues de la ruta se envia el objeto con los datos que se van a enviar a la base de datos
                ...
                // luego manejamos la respuesta en la consola
                .then(response => {
                    this.nombre_1='',
                    this.nombre_2='',
                    this.apellido_1='',
